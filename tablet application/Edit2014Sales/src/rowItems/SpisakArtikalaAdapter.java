...
public class SpisakArtikalaAdapter extends ArrayAdapter<Artikal> {
	
	private final Context context;
	private List<Artikal>listaArtikala;
	
	public SpisakArtikalaAdapter(Context context, List<Artikal> objects) {
		super(context,R.layout.row_za_kasu, objects);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.row_za_kasu, parent, false);
