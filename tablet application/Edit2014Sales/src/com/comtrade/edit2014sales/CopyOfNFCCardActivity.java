...
public class CopyOfNFCCardActivity extends Activity {
    ...
    private static boolean citanje;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) findViewById(R.id.txtPosjeta);
        
        broj = (TextView)CopyOfNFCCardActivity.this.findViewById(R.id.txtBroj);
        ime = (TextView)CopyOfNFCCardActivity.this.findViewById(R.id.txtIme);
        prezime = (TextView)CopyOfNFCCardActivity.this.findViewById(R.id.txtPrezime);
        poeni = (TextView)CopyOfNFCCardActivity.this.findViewById(R.id.txtPoeni);
        noviPoeni = (TextView)CopyOfNFCCardActivity.this.findViewById(R.id.txtNoviPoeni);
        posjeta = (TextView)CopyOfNFCCardActivity.this.findViewById(R.id.txtPosjeta);
        
        dialog = new Dialog(CopyOfNFCCardActivity.this);
 
		mNfcAdapter = NfcAdapter.getDefaultAdapter(this);
		
		if (mNfcAdapter == null) {
			// Stop here, we definitely need NFC
			Toast.makeText(this, "Uredaj ne podrzava NFC.",
		...
		if (!mNfcAdapter.isEnabled()) {
			Toast.makeText(this, "NFC nije ukljucen. Molimo ukljucite NFC.", Toast.LENGTH_LONG).show();
		} else {
		...
		SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(CopyOfNFCCardActivity.this);
		String points = preferences.getString("loyaltyPoints", "");
        ...
        Button upisi = (Button)CopyOfNFCCardActivity.this.findViewById(R.id.btnUpis);
        upisi.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				citanje = false;
				final Dialog dialog = new Dialog(CopyOfNFCCardActivity.this);
	...
	public WriteResponse writeTag(NdefMessage message, Tag tag) {  
	     ...
	     try {  
	       ...
	       if (ndef != null) {  
	         ...
	         String iznos = String.valueOf(Float.valueOf(poeni.getText().toString()) + Float.valueOf(noviPoeni.getText().toString()));
	         Date datum = new Date();
	         SimpleDateFormat df = new SimpleDateFormat("dd.MM.gggg");
	         String d = df.format(datum);
	         
	         kartica.setDatumZadnjePromjene(d);
	         kartica.setBrojBodova(iznos);
	         ndef.writeNdefMessage(createRecord(kartica.UpisKartice()));

	         noviPoeni.setText("0");
	         citanje = true;
	         dialog.dismiss();
	         CopyOfNFCCardActivity.this.finish();
	...
	private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
	    ...
	    protected void onPostExecute(String result) {
            if (result != null) {
                ...
                ImageView slika = (ImageView)CopyOfNFCCardActivity.this.findViewById(R.id.imageView1);
                Ion.with(slika)
